...
<body>
    <div class="form-container">
        ...
        <div class="form-header">
            <h2>Form Beli Sekarang</h2>
            <p>Pesan produk favorit Anda dengan mudah</p>
        </div>
        ...
        <form action="{{ route('beli.store') }}" method="POST">
            ...
            <div class="form-body">
                <div class="special-offer">
                    ⚡ Promo Spesial! Gratis Ongkir untuk Pembelian Hari Ini
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="produk" name="produk" class="form-control" 
                           placeholder="Masukkan nama produk yang ingin dibeli" required>
                    <span class="input-icon">📦</span>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="jumlah" name="jumlah" class="form-control" 
                           placeholder="Masukkan jumlah yang ingin dibeli" min="1" required>
                    <span class="input-icon">🔢</span>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="catatan" name="catatan" class="form-control" 
                              placeholder="Tambahkan catatan khusus atau permintaan (opsional)"></textarea>
                    <span class="input-icon">📝</span>
                </div>

                <div class="btn-container">
                    <button type="submit" class="btn btn-primary">
                        <span class="shopping-cart-icon">🛒</span> Beli Sekarang
                    </button>
        ...
        <div class="form-footer">
            <p>🔒 Transaksi Aman & Terpercaya | 💳 Berbagai Metode Pembayaran</p>
        </div>
    </div>
